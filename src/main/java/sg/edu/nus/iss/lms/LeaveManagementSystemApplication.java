...
public class LeaveManagementSystemApplication {
    ...
    CommandLineRunner loadData(AccountRepository accRepo,
		...
		return args -> {
			...
			leaveRepo.save(new Leave(brandonStaff, annual, LocalDate.of(2023, 12, 30), DaySection.AM, LocalDate.of(2023, 12, 26), DaySection.PM, "Local", "Holiday", "person1", "contact1", LeaveStatus.APPROVED));
