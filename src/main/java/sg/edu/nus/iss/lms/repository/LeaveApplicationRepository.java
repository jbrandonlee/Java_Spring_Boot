...
public interface LeaveApplicationRepository extends JpaRepository<LeaveApplication, Integer> {
	...
	@Query("SELECT l FROM LeaveApplication l WHERE l.leaveApprovalStatus = 'APPROVED' AND (l.leaveStartDate BETWEEN :startDate AND :endDate OR l.leaveEndDate BETWEEN :startDate AND :endDate OR :startDate BETWEEN l.leaveStartDate AND l.leaveEndDate)")
